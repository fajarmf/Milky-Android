...
public class ActionBar extends RelativeLayout {
	...
	public ActionBar(Context context, AttributeSet attrs) {
		...
		RelativeLayout barView = (RelativeLayout) mInflater.inflate(
		...
		mActionIconContainer = (LinearLayout) barView
				.findViewById(R.id.actionbar_actionIcons);
	}
	 ...
	 *            to handle click actions on the ActionIcon.
	 */
	public void addActionIcon(int iconResourceId,
			OnClickListener onClickListener) {
		// Inflate
		View view = mInflater.inflate(R.layout.actionbar_icon,
		...
		mActionIconContainer
				.addView(view, mActionIconContainer.getChildCount());
	}
